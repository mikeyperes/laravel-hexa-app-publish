...
Route::post('/search/images/batch', [SearchController::class, 'searchImagesBatch'])->name('publish.search.images.batch');
Route::post('/search/google-images', [SearchController::class, 'searchGoogleImages'])->name('publish.search.google-images');
