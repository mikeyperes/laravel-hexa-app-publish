...
class AppPublishServiceProvider extends ServiceProvider
{
    ...
    private function registerSidebarItems(): void
    {
        if (!config('hexa.app_controls_sidebar', false)) {
            ...
            $registry->registerSidebarLink('publish.templates.index', 'AI Templates', 'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z', 'Article', 'app-publish', 33);
            ...
            $registry->registerSidebarLink('publish.presets.index', 'WP Templates', 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4', 'Publishing', 'app-publish', 51);
