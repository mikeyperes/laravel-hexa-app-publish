...
class CampaignChecklistService
{
    ...
    public function definitions(string $deliveryMode = 'draft-wordpress'): array
    {
        ...
        return [
            ...
            $this->item('article', 'Create Article Record', 'Create the campaign article shell first so discovery, extraction, and generation can attach to a single record.', ['article']),
