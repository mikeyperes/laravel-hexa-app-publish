...
<a href="{{ route('publish.servers.index') }}?tab=accounts"
   class="flex items-center px-3 py-2 text-sm rounded-md transition-colors duration-150
          {{ request()->is('publish/servers*') && request('tab') === 'accounts' ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
    <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
